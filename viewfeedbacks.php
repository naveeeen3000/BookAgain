...
<head>
<meta charset="utf-8">
<title>BookAgain | Feedbacks</title>
...
<div class="sidenav">
  ...
  <a href="" class="btn active"><i class="fas fa-comments"></i>Feedbacks</a><hr size="2" width="215px;">
  <a href="contactsupport.php" class="btn"><i class="fas fa-address-card"></i>Contacts</a><hr size="2" width="215px;">
	...
	<p style="margin-left: 250px;margin-top: 0;padding-top:15px;font-size: 20px;color: white">Feedbacks</p>	
	</div>
...
?>	
  <tr>
    <td><?php echo $data['feedbackid']; ?></td>
    <td><?php echo $data['user_email']; ?></td>
    <td><?php echo $data['feedback_category']; ?></td>  
    <td><?php echo $data['rating']; ?></td> 
    <td><?php echo $data['review']; ?></td> 
	<td><?php echo $data['date']; ?></td>     
    <td><a href="deletesupport.php?feedbackid=<?php echo $data['feedbackid']; ?>"  class="delete"><i class="fas fa-minus-circle"></i></a></td>
  </tr>
<?php
}
?>	
