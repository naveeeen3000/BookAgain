...
if(isset($_GET['latestbooks'])){
$query = "SELECT book_isbn, book_title, book_image FROM books ORDER BY date_added";	
}else{
$query = "SELECT book_isbn, book_title, book_image FROM books";	
}
...
<p class="heading1">Full Catalog of Books</p>
