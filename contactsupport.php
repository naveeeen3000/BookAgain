...
<head>
<meta charset="utf-8">
<title>BookAgain | Contact Support</title>
...
<div class="sidenav">
  ...
  <a href="" class="btn  active"><i class="fas fa-address-card"></i>Contacts</a><hr size="2" width="215px;">
  </div>
  </div>
	...
	<p style="margin-left: 250px;margin-top: 0;padding-top:15px;font-size: 20px;color: white">Contact Support</p>	
	</div>
...
<?php
$records = mysqli_query($db,"select * from customersupport"); 
...
<!--	<td><i class="fas fa-reply" style="color: mediumseagreen"></i></td>  -->
    <td><a href="deletesupport.php?support_id=<?php echo $data['support_id']; ?>"  class="delete"><i class="fas fa-minus-circle" style="cursor: pointer;"></i></a></td>
  </tr>
<?php
}
?>	
