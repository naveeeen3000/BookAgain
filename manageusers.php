...
<head>
<meta charset="utf-8">
<title>BookAgain | ManageUsers</title>
...
<div class="sidenav">
  ...
  <a href="manageusers.php" class="btn active"><i class="fas fa-edit" style="padding-right: 6px;"></i>Manage Users</a><hr size="2" width="215px;">
  ...
  <a href="contactsupport.php" class="btn"><i class="fas fa-address-card"></i>Contacts</a><hr size="2" width="215px;">
	...
	<p style="margin-left: 250px;margin-top: 0;padding-top:15px;font-size: 20px;color: white">Manage Users</p>	
	</div>
...
<?php
$records = mysqli_query($db,"select * from users WHERE user_email!=''"); 
...
?>	
  <tr>
    ...
    <td><a href="deleteuser.php?user_email=<?php echo $data['user_email']; ?>"  class="delete"><i class="fas fa-user-times"></i></a></td>
  </tr>
<?php
}
?>	
