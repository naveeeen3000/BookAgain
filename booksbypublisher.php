...
include('envs.php');
  ...
  $query = "SELECT book_isbn, book_title, book_image FROM books WHERE publisher_name='$publisher_name'";
...
<title>BookAgain | ByPublisher</title>
...
<p class="heading1"><?php echo("$publisher_name");?></p>
